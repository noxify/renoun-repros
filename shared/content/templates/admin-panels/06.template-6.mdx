---
title: "Template: admin panels 6"
description: "Documentation for Template: admin panels 6"
---

# Template: admin panels 6

This is the documentation page for Template: admin panels 6.
