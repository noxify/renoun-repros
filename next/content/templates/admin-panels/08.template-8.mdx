---
title: "Template: admin panels 8"
description: "Documentation for Template: admin panels 8"
---

# Template: admin panels 8

This is the documentation page for Template: admin panels 8.
